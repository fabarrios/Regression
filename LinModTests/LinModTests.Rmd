...
The variable `chd69` shows whether or not the subject had a coronary event.  Other interesting varible to relate to the cholesteron level in blood is the *arcus senilis*, a milky ring in the iris associated with high cholesterol levels, `arcus` is a variable with 1 for presence of the arcus senilis and 0 for the reference group.  
...
The $H_1$: the full model significantly outperforms the nested model. (conclussion you keep the full model).  
