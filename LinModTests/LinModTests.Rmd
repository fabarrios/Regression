...
To compare the two models we use the null hypothesis: $H_0$: both, the full and the nested models fit the data equally well. (if you cannot discard $H_0$ therefore you should
take the nested model, Occam's razor). And the alternative hypothesis is $H_1$: the full model significantly outperforms the nested model (conclusion: you keep the full model).  
