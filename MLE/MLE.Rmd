...
Que es la Estimación por Máxima Probabilidad --Maximum Likelihood Estimation (MLE)-- ? (en este comentario vamos a usar likelihood --probabilidad, posibilidad-- como posibilidad). Este comentario surgió del comentario en R-Loggers y de la entrada en el blog llamada "Maximum likelihood distilled" [^1]
