...
where we used the "link transformation" that is the exponentiation, to obtain the odds of *Y* (logit). In the `effects` library there is a general plotting function for ploting all the predictor effect plots used in a model.  
