---
title: "t-Test and Anova, refresh"
...
## Introduction. 
To execute two sample comparisons the simplest is the best, as always we must apply Occam's razor. So the classical tests to estimate comparisons between two samples are some of the most frequently-used kinds of analysis and we have the R functions:  
