...
The examples for chapter 3 (Vittinghoff's book http://www.biostat.ucsf.edu/vgsm) using data from the heart and estrogen/progestin study (HERS), a clinical trial of hormone therapy (HT) for prevention of recurrent heart attacks and death among 2,763 post-menopausal women with existing coronary heart disease (CHD). We will present some exercises from Daniel's book, and this will cover a refresher for t-test and ANOVA (assuming parametric distributions).

## Introduction
Basic tools for assessing the statistical significance of differences between the average values of a continuous outcome across two or more samples folowing parametric sttisctics are the t-Test and ANOVA.
