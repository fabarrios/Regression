...
leuk <- read_csv("DataRegressBook/Chap3/leuk.csv")
```
...
### The Kaplan–Meier Procedure examples from Daniel  
...
Definition: The survival function at time *t*, denoted *S(t)* is the probability of being eventfree at time *t*; equivalently, the probability that the survival time is greater than t.  
