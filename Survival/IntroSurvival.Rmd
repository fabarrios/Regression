...
plot(survfit(Surv(time, cens) ~ group, data = leuk), main = "Acute Lymphoblastic Leukemia", lty = c(1,2), 
     legend.text = c("Placebo", "6-MP"), legend.bty = "n", ylab = "Probability", xlab = "Time weeks")
...
plot(survfit(mod.Recidivism), xlab="Weeks", ylab="Proportion Not Rearrested")
# now with better scale
plot(survfit(mod.Recidivism), ylim = c(0.4, 1), xlab="Weeks", ylab="Proportion Not Rearrested")
